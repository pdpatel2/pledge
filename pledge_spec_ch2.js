...
describe("A promise's .then method", function(){
  ...
  }); // handlerGroups:[{succesCb:successCb, errorCb: errorCb}]
...
describe('A promise', function(){
  ...
  beforeEach(function(){
    numDeferral = defer(); //instance of Deferral
...
// numDeferral = {promiseForNum:{handlerGroups:[{successCb: fn.setFoo10, errorCb: }], state: 'resolved'}
